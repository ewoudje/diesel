...
const K = {anchor: {Left: 0, Top: 0}}, J = ["background", "value"], X = {anchor: {Left: -20, Bottom: -50, Height: 100}},
    q = {anchor: {Left: -30, Bottom: 0, Width: 1e3, Height: 440}}, Q = ["background", "mask-texture-path"],
    Y = ["background"], Z = ["el-style"], tt = ["background"], ot = ["background"], et = {anchor: {Top: 0, Right: -35}},
    nt = ["background"], at = ["el-style"], rt = ["el-style"], lt = {anchor: {Right: 0}}, ut = ["background"],
    st = ["background"], it = ["background"], gt = ["background"], ht = ["background", "mask-texture-path"],
    pt = {anchor: {Left: 8}}, ct = {
        anchor: {Left: 2},
        "el-style": {
            FontName: "Secondary"
        ...
        anchor: {Top: 78}
    }, ft = {anchor: {Right: -20, Bottom: -52}}, yt = ["background"], Lt = ["background", "mask-texture-path"],
    Gt = ["background"], It = ["anchor"], Tt = ["el-style"], Ct = ["anchor", "el-style"], Ht = {
        key: 1,
        anchor: {Top: -30},
        "layout-mode": "Top"
    }, St = ["el-style"], Wt = ["el-style"], Ft = {anchor: {Top: 5, Left: 360}}, Bt = {"layout-mode": "Top"},
    Rt = ["background", "value"], xt = ["el-style"], Et = ["background", "value"], Nt = ["el-style"],
    _ = /* @__PURE__ */ O({
        __name: "DieselHud",
        setup(x) {
            ...
            const f = r("chain", ""), T = r("dashes", 4), z = r("objective", ""), A = r("class", "scout"),
                p = r("hotbarIdx", 0), C = r("health", 1);
            r("overlay", "none");
            const P = r("progress1", 0), w = r("progress1Label", ""), V = r("progress2"), y = r("progress2Label", ""),
                H = r("currentLevel", "");
            L(T, (u, o) => {
